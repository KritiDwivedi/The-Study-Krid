# The-Study-Krid
Most study applications turn notes into another ordinary quiz. The Study Krid turns learning into a conversation, a game, and an adventure.Students can paste notes in any format, dictate them, upload a PDF, or add a recorded lecture. The app organises that material into meaningful concepts and transforms it into lessons !
...
* Six deep featured worlds cover fractions, photosynthesis, JavaScript, the Solar System, human digestion, and climate science.And many more topics to choose from !
...
All artwork, sounds, interface elements, copy, and learning content in this repository are original or generated directly in code. There are no third-party trademarks, copyrighted characters, music files, or fonts. The optional PDF importer uses Mozilla PDF.js, distributed under the Apache-2.0 license. The optional lecture POC uses pinned Transformers.js and a browser-compatible Whisper Tiny English model, both loaded only on demand.
